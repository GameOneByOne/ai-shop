...
const links=[["/dashboard","Dashboard"],["/products/discover","货源发现"],["/products/candidates","选品池"],["/suppliers","供应商"],["/skus","SKU"],["/analytics/daily","经营数据"],["/ai-manager","AI 店长"],["/tasks","任务"],["/experiments","实验"],["/reports/daily","报告"],["/settings","设置"]];
