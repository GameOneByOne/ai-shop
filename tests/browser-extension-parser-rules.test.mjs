...
assert.match(selectionCenter, /"AI识别分类与评估"/, "现有货源页必须提供合并后的AI主按钮");
assert.match(selectionCenter, /"规则初筛"/, "现有货源页必须提供确定性规则初筛按钮");
...
assert.match(selectionCenter, /重新解析数据缺失项/, "结果页顶部必须提供数据缺失项批量重新解析按钮");
